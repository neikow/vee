...
VkImageView Vulkan::VulkanDevice::CreateImageView(
    const VkImage &image,
...
VkCommandBuffer Vulkan::VulkanDevice::BeginSingleTimeCommands(
...
void Vulkan::VulkanDevice::EndSingleTimeCommands(
